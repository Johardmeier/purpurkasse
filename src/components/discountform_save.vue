<template>
  <v-layout row justify-center>
    ...
    <v-dialog
      ...
      persistent
    >
      <v-toolbar color="purple darken-3 " tabs >
        <v-toolbar-side-icon></v-toolbar-side-icon>
        <v-toolbar-title>Rabatte</v-toolbar-title>
        <v-spacer></v-spacer>
        <v-toolbar-title class="grey--text">{{item.forename}} {{item.name}}</v-toolbar-title>
